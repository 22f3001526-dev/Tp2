...
```bash
git clone https://github.com/22f3001526-dev/tds.git
cd tds-geniesolver
```
...
For questions or issues, please open an issue on the [GitHub repository](https://github.com/22f3001526-dev/tds).